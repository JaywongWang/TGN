...
def evaluation_metric_util(options, data_provision, sess, inputs, outputs, split='val'):
    """
    ...
    :param outputs: output placeholders
    ...
    for batch_data in data_provision.iterate_batch(split, eval_batch_size):
        ...
        for video_feat_id in range(max_feat_len):
            ...
            proposal_score, video_c_state, video_h_state, interactor_c_state, interactor_h_state = \
                sess.run([outputs['proposal_score'], outputs['video_c_state'], outputs['video_h_state'],
        ...
        for sample_id in range(this_batch_size):
            ...
            for i in range(feat_len):
                for j in range(len(anchors)):
                    ...
                    score = float(proposal_scores[sample_id, i, j])
